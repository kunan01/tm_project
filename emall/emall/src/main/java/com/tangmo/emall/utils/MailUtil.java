...
public class MailUtil {
    ...
    public static String send_mail(String email) throws MessagingException {
        ...
        String content = "<html><head></head><body><div style=\"height: 100vh;background: #fff;\">\n" +
                "   <p style=\"text-indent: 2em;padding-top: 20vh;\"><span>Dear users, Your platform verification code is: </span><span style=\"margin-left: 2%;\">"+str+"</span></p >\n" +
                "  </div></body></html>";
