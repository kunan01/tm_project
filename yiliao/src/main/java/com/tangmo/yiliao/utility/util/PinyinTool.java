...
public class PinyinTool {
    ...
    public static void main(String[] args){
        ...
        System.out.println(tool.toPinYin("权限管理", "", Type.UPPERCASE));
//        System.out.println(tool.toPinYin("模块信息", "", Type.UPPERCASE));
//        System.out.println(tool.toPinYin("模块管理", "", Type.UPPERCASE));
//        System.out.println(tool.toPinYin("角色管理", "", Type.UPPERCASE));
    }
}