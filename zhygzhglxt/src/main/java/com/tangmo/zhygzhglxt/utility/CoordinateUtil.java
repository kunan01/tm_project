...
public class CoordinateUtil {
    ...
    public static Gps transform2Mars(double wgLat, double wgLon) {
        ...
        if (outOfChina(wgLat, wgLon)) {
            mgLat = wgLat;
            mgLon = wgLon;
            return new Gps(String.valueOf(mgLat), String.valueOf(mgLon));
        }
    ...
    public static Gps bd_encrypt(double gg_lat, double gg_lon) {
        ...
        return new Gps(String.valueOf(bd_lat), String.valueOf(bd_lon));
    }
     ...
     * 百度转火星
     *
     * @param bd_lat,bd_lon百度坐标 //* @param gg_lat,gg_lon
     *                          火星坐标
     */
    public static Gps bd_decrypt(double bd_lat, double bd_lon) {
        ...
        return new Gps(String.valueOf(gg_lat), String.valueOf(gg_lon));
    }
