...
public class WxwsMsg {

    public static String sendMsg(String mobile) throws Exception {
        String code = "";
        try {
            String content = "您的短信验证码为:@,请在1分钟内按照页面提交验证码,切勿将验证码泄漏于他人。";// utf-8
            code = sixRandomNumber();
...
//			String CorpID = "XAJS007246";// 账户名LKHHHqqq
//			String Pwd = "fv@7246";// 密码322221

//			//回复信息查询
//			getReplyMsg(CorpID, Pwd);
//			//余额查询
//			getSelSum(CorpID, Pwd);
//			//获取禁止号码
//			getNotSend(CorpID, Pwd);
     ...
     * @param Mobile    手机号码
     * @param Content   发送内容
     * @param send_time 定时发送的时间；可以为空，为空时为及时发送
     * @return 返回值
